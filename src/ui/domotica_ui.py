...
#
# Created: Mon Jun 29 00:33:23 2009
...
class Ui_Domotica(object):
    def setupUi(self, Domotica):
        ...
        Domotica.setStyleSheet("background-color:rgb(170, 170, 127);")
        self.verticalLayoutWidget_2 = QtGui.QWidget(Domotica)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 20, 891, 771))
