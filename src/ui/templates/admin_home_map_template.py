...
# Form implementation generated from reading ui file './templates/admin_home_map_template.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.home_map_view, 0, 2, 7, 2)
        spacerItem = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem, 5, 0, 1, 2)
        self.selection_list = QtGui.QListWidget(Form)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.selection_list.sizePolicy().hasHeightForWidth())
        self.selection_list.setSizePolicy(sizePolicy)
        self.selection_list.setObjectName("selection_list")
        self.gridLayout.addWidget(self.selection_list, 4, 0, 1, 2)
